...
if ( require('config.php') ) {
	...
	// also delete the dummy.config file we created to make WebMatrix work
	$dummy_file = APP_ROOT . '/dummy.config';
	...
	echo "Something wrong with your Pligg installation, please make sure that Pligg is installed completely";
}
